...
**CONCEPTS AND KEYWORDS:** * Azure Account, Azure Subscription, Core architectural components: 1. physical infrastructure (datacenters, regions, availability zones) 
2. management infrastructure (Azure resources, resource groups, subscriptions, accounts), ways to interact with Azure environment, Azure Global Infrastructure *
